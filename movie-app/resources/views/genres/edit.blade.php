        ...
        <div class="card-body">
            <form method="POST" action="/genres/{{ $genre->id }}">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="exampleFormControlInput1" class="form-control" name="nama" value="{{ $genre->nama }}">
                    </div>
                  </div>
                <div class="mb-3 row">
                    <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Deskripsi </label>
                    <div class="col-sm-10">
                      <input type="text" id="exampleFormControlInput1" class="form-control" name="deskripsi" value="{{ $genre->deskripsi }}">
                    </div>
                  </div>
